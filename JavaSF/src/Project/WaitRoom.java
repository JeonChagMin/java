...
//		room에 대한 정보를 각각 가지고 온 다음 while문으로 각각 정보를 저장
...
//		userVector에 들어가 있는 유저의 정보를 각각 저장
		while (enu.hasMoreElements()) {
